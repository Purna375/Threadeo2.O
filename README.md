<div align="center">
  ...
  <h3 align="center">A full stack Threads Clone, I call it as Threadeo2.O</h3>
...
```bash
git clone [https://github.com/Purna375/Threadeo2.O.git](https://github.com/Purna375/Threadeo2.O.git)
cd threads
```
